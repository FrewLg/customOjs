...
/* Smarty version 4.3.1, created on 2024-07-25 10:51:47
  from 'app:frontendcomponentsheaderSection.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_66a22e437e4d83_66767830',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '5c0d8a5c0540817159df25c699d456d9d6362ffa' => 
    array (
      0 => 'app:frontendcomponentsheaderSection.tpl',
      1 => 1721847885,
      2 => 'app',
    ),
  ),
...
function content_66a22e437e4d83_66767830 (Smarty_Internal_Template $_smarty_tpl) {
         ...
         <div class="relative z-10 md:text-center lg:text-left">
            ...
            <div class="relative">
              ...
              <div class="mt-8 flex gap-4 md:justify-center lg:justify-start">
                <a class="rounded-full bg-<?php echo $_smarty_tpl->tpl_vars['materialBaseColour']->value;?>
-300 py-2 px-4 text-sm font-semibold text-slate-900 hover:bg-<?php echo $_smarty_tpl->tpl_vars['materialBaseColour']->value;?>
-200 focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-<?php echo $_smarty_tpl->tpl_vars['materialBaseColour']->value;?>
-300/50 active:bg-<?php echo $_smarty_tpl->tpl_vars['materialBaseColour']->value;?>
-500" href="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('router'=>(defined('ROUTE_PAGE') ? constant('ROUTE_PAGE') : null),'page'=>"about",'op'=>"submissions"),$_smarty_tpl ) );?>
" role="button">
                ...
                <a class="rounded-full bg-slate-800 py-2 px-4 text-sm font-medium text-white hover:bg-slate-700 focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white/50 active:text-slate-400" href="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('router'=>(defined('ROUTE_PAGE') ? constant('ROUTE_PAGE') : null),'page'=>"issue",'op'=>"archive"),$_smarty_tpl ) );?>
">
