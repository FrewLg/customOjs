...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='The order that a word or phrase used in a controlled vocabulary should appear. For example, the order of keywords in a publication.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `controlled_vocab_entries` VALUES (5,6,1.00),(6,6,2.00),(7,6,3.00),(8,6,4.00);
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='More data about a controlled vocabulary entry, including localized properties such as the actual word or phrase.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `controlled_vocab_entry_settings` VALUES (5,5,'en','submissionKeyword','test key','string'),(6,6,'en','submissionKeyword','key2','string'),(7,7,'en','submissionKeyword','for test','string'),(8,8,'en','submissionKeyword','keywords for test','string');
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='A log of all events related to an object like a submission.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `issue_settings` VALUES (1,1,'en','description',''),(2,1,'en','title','Matomo test'),(3,1,'en','coverImage','cover_issue_1_en.png');
...
INSERT INTO `issues` VALUES (1,1,1,'1',2024,1,'2024-07-25 08:55:44',NULL,'2024-07-25 08:55:44',1,NULL,1,1,1,1,NULL,NULL,NULL,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='All pending or in-progress jobs.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=116 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='More data about journals, including localized properties like policies.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `journals` VALUES (1,'schin',1.00,'en',1,1),(2,'schintwo',2.00,'en',1,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='Daily statistics for views of the homepage.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `metrics_context` VALUES (1,'usage_events_20240724.log',1,'2024-07-24',1);
...
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='More data about navigation menu item assignments to navigation menus, including localized content.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=75 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='Links navigation menu items to navigation menus.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `navigation_menu_item_assignments` VALUES (1,1,1,0,0),(2,1,2,0,1),(3,1,3,0,2),(4,1,4,3,0),(5,1,5,3,1),(6,1,6,3,2),(7,1,7,3,3),(8,2,8,0,0),(9,2,9,0,1),(10,2,10,0,2),(11,2,11,10,0),(12,2,12,10,1),(13,2,13,10,2),(14,2,14,10,3),(24,3,15,0,0),(25,3,16,0,1),(26,3,17,0,2),(27,3,18,0,3),(28,3,19,18,4),(29,3,20,18,5),(30,3,21,18,6),(31,3,22,18,7),(32,3,23,18,8),(33,3,24,0,9),(34,4,25,0,0),(35,4,26,0,1),(36,4,27,0,2),(37,4,28,27,0),(38,4,29,27,1),(39,4,30,27,2),(40,4,31,27,3),(41,5,32,0,0),(42,5,33,0,1),(43,5,34,0,2),(44,5,35,0,3),(45,5,36,35,0),(46,5,37,35,1),(47,5,38,35,2),(48,5,39,35,3),(49,5,40,35,4),(65,6,44,0,0),(66,6,43,0,1),(67,6,45,43,2),(68,6,42,43,3),(69,6,47,0,4),(70,6,50,0,5),(71,6,46,0,6),(72,6,49,0,7),(73,6,48,0,8),(74,6,51,0,9);
...
) ENGINE=InnoDB AUTO_INCREMENT=72 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='More data about navigation menu items, including localized content such as names.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=52 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='Navigation menu items are single elements within a navigation menu.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=70 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='More data about notifications, including localized properties.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=71 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='User notifications created during certain operations.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=104 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='More data about plugins, including localized properties. This table is frequently used to store plugin-specific configuration.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `publications` VALUES (1,0,NULL,'2024-07-25 08:55:09',NULL,1,0.00,1,1,NULL,1,NULL),(2,0,'2024-01-31','2024-07-25 08:59:19',1,1,0.00,2,3,NULL,1,NULL);
...
INSERT INTO `scheduled_tasks` VALUES (1,'PKP\\task\\ReviewReminder','2024-07-25 15:18:31'),(2,'PKP\\task\\StatisticsReport','2024-07-24 14:34:35'),(3,'APP\\tasks\\SubscriptionExpiryReminder','2024-07-24 14:34:35'),(4,'PKP\\task\\DepositDois','2024-07-25 15:18:31'),(5,'PKP\\task\\RemoveUnvalidatedExpiredUsers','2024-07-24 14:34:35'),(6,'PKP\\task\\EditorialReminders','2024-07-24 14:34:35'),(7,'PKP\\task\\UpdateIPGeoDB','2024-07-24 14:34:35'),(8,'APP\\tasks\\UsageStatsLoader','2024-07-25 15:18:31'),(9,'PKP\\task\\ProcessQueueJobs','2024-07-25 15:18:31'),(10,'PKP\\task\\RemoveFailedJobs','2024-07-24 14:34:54'),(11,'APP\\tasks\\OpenAccessNotification','2024-07-25 15:18:31'),(12,'APP\\plugins\\importexport\\doaj\\DOAJInfoSender','2024-07-24 19:04:45');
...
INSERT INTO `submission_search_object_keywords` VALUES (128,1,1,0),(129,1,2,1),(130,1,1,2),(131,1,2,3),(132,1,3,4),(133,1,4,5),(134,1,5,6),(135,1,3,7),(136,1,4,8),(137,1,5,9),(138,2,6,0),(139,2,7,1),(140,2,8,2),(141,2,9,3),(142,2,10,4),(143,2,11,5),(144,3,12,0),(145,3,13,1),(146,3,14,2),(147,3,15,3),(148,3,16,4),(149,3,17,5),(150,3,18,6),(151,3,19,7),(152,3,20,8),(153,3,21,9),(154,3,22,10),(155,3,23,11),(156,3,24,12),(157,3,25,13),(158,3,26,14),(159,3,27,15),(160,3,28,16),(161,3,21,17),(162,3,29,18),(163,3,30,19),(164,3,31,20),(165,3,32,21),(166,3,33,22),(167,3,34,23),(168,3,35,24),(169,3,36,25),(170,3,37,26),(171,3,20,27),(172,3,17,28),(173,3,38,29),(174,3,39,30),(175,3,40,31),(176,3,41,32),(177,3,42,33),(178,3,43,34),(179,3,20,35),(180,3,44,36),(181,3,45,37),(182,3,46,38),(183,3,17,39),(184,3,47,40),(185,3,20,41),(186,3,48,42),(187,3,47,43),(188,3,15,44),(189,3,49,45),(190,3,50,46),(191,3,51,47),(192,3,52,48),(193,3,53,49),(194,3,54,50),(195,3,55,51),(196,3,56,52),(197,3,57,53),(198,3,24,54),(199,3,58,55),(200,3,59,56),(201,3,20,57),(202,3,26,58),(203,3,60,59),(204,3,61,60),(205,3,62,61),(206,3,63,62),(207,3,64,63),(208,3,56,64),(209,3,65,65),(210,3,49,66),(211,3,66,67),(212,3,67,68),(213,3,68,69),(214,3,69,70),(215,3,70,71),(216,3,71,72),(217,3,72,73),(218,3,73,74),(219,3,74,75),(220,3,75,76),(221,3,76,77),(222,3,77,78),(223,3,33,79),(224,3,78,80),(225,3,79,81),(226,3,20,82),(227,3,80,83),(228,3,81,84),(229,3,82,85),(230,3,83,86),(231,3,84,87),(232,3,20,88),(233,3,85,89),(234,3,22,90),(235,3,26,91),(236,3,55,92),(237,3,85,93),(238,3,12,94),(239,5,86,0),(240,5,87,1),(241,5,88,2),(242,5,86,3),(243,5,89,4),(244,5,86,5);
...
INSERT INTO `submission_search_objects` VALUES (1,2,1,NULL),(2,2,2,NULL),(3,2,4,NULL),(4,2,16,NULL),(5,2,17,NULL),(6,2,8,NULL),(7,2,32,NULL),(8,2,64,NULL);
...
INSERT INTO `submissions` VALUES (1,1,1,'2024-07-25 08:55:09',NULL,'2024-07-25 08:55:09',1,'en',1,'start',0),(2,1,2,'2024-07-25 08:59:20','2024-07-25 08:59:19','2024-07-25 08:59:19',5,'en',3,'',0);
...
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='Temporary files, e.g. where files are kept during an upload process before they are moved somewhere more appropriate.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `temporary_files` VALUES (1,1,'pngMEoOEH','image/png',284776,'pageHeaderTitleImage_en_US.png','2024-07-24 19:06:08'),(2,1,'png7bQWiA','image/png',284776,'pageHeaderTitleImage_en_US.png','2024-07-25 06:09:33'),(3,1,'pngBaUPOV','image/png',358,'download.png','2024-07-25 06:09:41'),(4,1,'pngQhMFjx','image/png',329660,'ephi.png','2024-07-25 06:10:25'),(11,1,'png92ZjVz','image/png',358,'download.png','2024-07-25 08:55:34'),(12,1,'png6gHsjJ','image/png',358,'download.png','2024-07-25 09:24:33');
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='Temporary stats totals based on visitor log records. Data in this table is provisional. See the metrics_* tables for compiled stats.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (1,'superadmin','$2y$10$jUYPXU5KTnh8LlRnxPmgdu8VGr6Kk9.phxSS4UTGMASHqxIdOnn2q','frew.legese@outlook.com',NULL,NULL,NULL,NULL,NULL,'[]',NULL,NULL,'2024-07-24 14:34:31',NULL,'2024-07-25 17:35:27',NULL,NULL,NULL,0,NULL,1);
...
-- Dump completed on 2024-07-26 10:59:08
