...
<table width="100%" class="data">
	...
	<tr valign="top">
		<td class="label">{fieldLabel name="reviewerCreditsJournalF3" key="plugins.generic.reviewerCredits.manager.settings.reviewerCreditsJournalF3"}</td>
		<td >{fbvElement type="checkbox" style="width: 17px; height:17px; margin-top: 10px;" name="reviewerCreditsJournalF3" id="reviewerCreditsJournalF3" value="1" checked=$reviewerCreditsJournalF3 }</td>
	</tr>
	<tr valign="top">
		<td class="label">{fieldLabel name="reviewerCreditsEditorData" key="plugins.generic.reviewerCredits.manager.settings.reviewerCreditsEditorData"}</td>
		<td >{fbvElement type="checkbox" style="width: 17px; height:17px; margin-top: 10px;" name="reviewerCreditsEditorData" id="reviewerCreditsEditorData" value="1" checked=$reviewerCreditsEditorData }</td>
	</tr>
</table>
