...
function(){if("undefined"!==typeof tinyMCE){tinyMCE.PluginManager.load("pkpTags",a.pkp.app.baseUrl+"/plugins/generic/tinymce/plugins/pkpTags/plugin.js");tinyMCE.PluginManager.load("pkpwordcount",a.pkp.app.baseUrl+"/plugins/generic/tinymce/plugins/pkpWordcount/plugin.js");var b={width:"100%",resize:"both",entity_encoding:"raw",plugins:"paste,fullscreen,link,lists,code,image,-pkpTags,noneditable",convert_urls:!1,forced_root_block:"p",paste_auto_cleanup_on_paste:!0,apply_source_formatting:!1,toolbar:"copy paste | bold italic underline | link unlink code fullscreen | image | pkpTags",
richToolbar:"copy paste | bold italic underline | bullist numlist | superscript subscript | link unlink code fullscreen | image | pkpTags",statusbar:!1,content_css:a.pkp.app.tinyMceContentCSS,browser_spellcheck:!0};"undefined"!==typeof a.pkp.plugins.generic.tinymceplugin&&"undefined"!==typeof a.pkp.plugins.generic.tinymceplugin.uploadUrl&&(b.paste_data_images=!0,b.relative_urls=!1,b.remove_script_host=!1,b.images_upload_handler=function(c,d,e){var f=new FormData;f.append("file",c.blob(),c.filename());
a.ajax({method:"POST",url:a.pkp.plugins.generic.tinymceplugin.uploadUrl,data:f,processData:!1,contentType:!1,headers:{"X-Csrf-Token":pkp.currentUser.csrfToken},success:function(k){d(k.url)},error:function(k){e(k.responseJSON.errorMessage)}})});b="undefined"!==typeof a.pkp.plugins.generic.tinymceplugin&&typeof a.pkp.plugins.generic.tinymceplugin.tinymceParams?a.extend({},b,a.pkp.plugins.generic.tinymceplugin.tinymceParams):a.extend({},b);b.init_instance_callback=a.pkp.controllers.SiteHandler.prototype.triggerTinyMCEInitialized;
b.setup=a.pkp.controllers.SiteHandler.prototype.triggerTinyMCESetup;tinyMCE.init(b)}};a.pkp.controllers.SiteHandler.prototype.triggerTinyMCEInitialized=function(b){a("#"+a.pkp.classes.Helper.escapeJQuerySelector(b.id)).trigger("tinyMCEInitialized",[b])};a.pkp.controllers.SiteHandler.prototype.triggerTinyMCESetup=function(b){var c=a("#"+a.pkp.classes.Helper.escapeJQuerySelector(b.id));c.attr("readonly")&&(b.settings.readonly=!0);c.attr("wordCount")&&0<c.attr("wordCount")&&(b.settings.plugins+=",pkpwordcount",
b.settings.statusbar=!0);c.attr("dir")&&(b.settings.directionality=c.attr("dir"));c=c.attr("rows")||10;b.settings.height=(20*c).toString()+"px";b.on("init",function(d){var e=a("#"+d.id);var f=a("#"+d.id).attr("placeholder");if(""!==f){var k=a("<span></span>");k.html(f);k.addClass("mcePlaceholder");k.attr("id","mcePlaceholder-"+d.id);d.target.getContent().length&&k.hide();d=a("<div></div>");d.addClass("mcePlaceholderParent");e.wrap(d);e.parent().append(k)}});b.on("activate",function(d){a("#mcePlaceholder-"+
d.id).hide()});b.on("deactivate",function(d){d.target.getContent().length||a("#mcePlaceholder-"+d.id).show()});b.on("BeforeSetContent",function(d){var e=a.pkp.classes.TinyMCEHelper.prototype.getVariableMap("#"+a.pkp.classes.Helper.escapeJQuerySelector(b.id));d.content=d.content.replace(/\{\$([a-zA-Z]+)\}(?![^<]*>)/g,function(f,k,g,n){return void 0!==e[k]?a.pkp.classes.TinyMCEHelper.prototype.getVariableElement(k,e[k],"#"+b.id).html():f})});b.on("GetContent",function(d){var e=a("<div>"+d.content+"</div>");
e.find(".pkpTag").replaceWith(function(){return"{$"+a(this).attr("data-symbolic")+"}"});d.content=e.html()});b.on("FullscreenStateChanged init",function(d){d=d.target;var e=a(d.editorContainer);d.plugins.fullscreen&&(d.plugins.fullscreen.isFullscreen()?e.find(".tox-menubar").show():e.find(".tox-menubar").hide())})};a.pkp.controllers.SiteHandler.prototype.getWindowDimensions=function(){return{height:a(window).height(),width:a(window).width()}};a.pkp.controllers.SiteHandler.prototype.redirectToUrl=
function(b,c,d){window.location=d};a.pkp.controllers.SiteHandler.prototype.registerUnsavedFormElement_=function(b,c,d){b=a(d.target.lastElementChild).attr("id");-1==a.inArray(b,this.unsavedFormElements_)&&this.unsavedFormElements_.push(b)};a.pkp.controllers.SiteHandler.prototype.unregisterUnsavedFormElement_=function(b,c,d){b=a(d.target.lastElementChild).attr("id");b=a.inArray(b,this.unsavedFormElements_);-1!==b&&delete this.unsavedFormElements_[b]};a.pkp.controllers.SiteHandler.prototype.unregisterAllFormElements_=
function(){this.unsavedFormElements_=[]};a.pkp.controllers.SiteHandler.prototype.fetchNotificationHandler_=function(b,c,d){void 0!==d?this.showNotification_(d):a.ajax({url:this.options_.fetchNotificationUrl,data:this.options_.requestOptions,success:this.callbackWrapper(this.showNotificationResponseHandler_),dataType:"json",async:!1})};a.pkp.controllers.SiteHandler.prototype.reloadTabHandler_=function(b,c,d){a(d.tabsSelector).tabs("load",d.tabSelector)};a.pkp.controllers.SiteHandler.prototype.callWhenClickOutsideHandler_=
